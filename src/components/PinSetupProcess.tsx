...
const PinSetupProcess: React.FC<PinSetupProcessProps> = ({ onComplete, onBack }) => {
  ...
  const renderPinInput = (value: string, onChange: (val: string) => void, placeholder: string) => (
        ...
        {[...Array(6)].map((_, i) => (
          <div
            ...
            className={`w-12 h-12 border-2 rounded-lg flex items-center justify-center text-xl font-bold ${
              value.length > i ? 'border-blue-500 bg-blue-50' : 'border-gray-300'
            }`}
          >
            {value[i] ? '•' : ''}
          </div>
        ...
        return (
          <Card className="w-full max-w-md mx-auto">
            <CardHeader className="text-center">
              ...
              <p className="text-sm text-gray-600">Masukkan 6 digit PIN untuk mengamankan aplikasi</p>
            </CardHeader>
            <CardContent className="space-y-6">
              {renderPinInput(pin, (val) => handlePinInput(val), "Masukkan PIN")}
        ...
        return (
          <Card className="w-full max-w-md mx-auto">
            <CardHeader className="text-center">
              ...
              <p className="text-sm text-gray-600">Masukkan ulang PIN untuk konfirmasi</p>
            </CardHeader>
            <CardContent className="space-y-6">
              {renderPinInput(confirmPin, (val) => handlePinInput(val, true), "Konfirmasi PIN")}
              <div className="flex gap-2">
        ...
        return (
          <Card className="w-full max-w-md mx-auto">
            <CardHeader className="text-center">
              ...
              <p className="text-sm text-gray-600">Aplikasi Anda sekarang aman dengan PIN</p>
            </CardHeader>
            <CardContent>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500">Mengalihkan ke pengaturan...</p>
              </div>
            </CardContent>
          </Card>
        );
