...
const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-4 pb-4 px-2">
      {/* Header Welcome */}
      <div className="bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 text-white p-4 rounded-2xl shadow-xl">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
            <Sparkles className="h-5 w-5 text-white" />
          </div>
          <div className="flex-1 min-w-0">
            <h1 className="text-lg font-bold truncate">Good Family</h1>
            <p className="opacity-90 text-sm truncate">Halo, {profile?.full_name || user?.email} 👋</p>
          </div>
        </div>
        {isHeadOfFamily && (
          <Badge className="bg-gradient-to-r from-yellow-400 to-orange-400 text-yellow-900 font-semibold border-0 text-xs">
            ✨ Ketua
          </Badge>
        )}
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-800 hover:shadow-md transition-all">
          <CardContent className="p-3 text-center">
            ...
            <div className="text-xl font-bold text-blue-700 dark:text-blue-300">{groups.length}</div>
            <div className="text-xs text-blue-600 dark:text-blue-400">Grup Aktif</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-green-200 dark:border-green-800 hover:shadow-md transition-all">
          <CardContent className="p-3 text-center">
            ...
            <div className="text-xl font-bold text-green-700 dark:text-green-300">{onlineDevices.length}</div>
            <div className="text-xs text-green-600 dark:text-green-400">Device Online</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border-purple-200 dark:border-purple-800 hover:shadow-md transition-all">
          <CardContent className="p-3 text-center">
            ...
            <div className="text-xl font-bold text-purple-700 dark:text-purple-300">{currentUserDevices.length}</div>
            <div className="text-xs text-purple-600 dark:text-purple-400">Device Saya</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border-orange-200 dark:border-orange-800 hover:shadow-md transition-all">
          <CardContent className="p-3 text-center">
            ...
            <div className="text-xl font-bold text-orange-700 dark:text-orange-300">{filteredActivities.length}</div>
            <div className="text-xs text-orange-600 dark:text-orange-400">Aktivitas Grup</div>
          </CardContent>
        </Card>
      </div>
        ...
        <CardHeader className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-blue-900/20 rounded-t-lg pb-3">
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-base dark:text-white">Aktivitas Anggota Grup</span>
            </div>
            ...
            {filteredActivities.length > 0 ? (
              filteredActivities.slice(0, 5).map((activity: any, index: number) => (
                <div key={activity.id || index} className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                  <div className="w-7 h-7 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center text-white font-bold text-xs flex-shrink-0">
              ...
              <div className="text-center py-6">
                ...
                <p className="text-gray-500 dark:text-gray-400 font-medium text-sm">Belum ada aktivitas anggota grup</p>
